...
public class ChoosecolumnDriver {
...
//                                    按类反射，灵活，可动态变化
        job.setJarByClass(ChoosecolumnDriver.class);//存储位置根据WordcountDriver类的位置

//        3.关联map和reduce类
        job.setMapperClass(ChoosecolumnMapper.class);
//        job.setReducerClass(ChoosecolumnReducer.class);
...
//        6.设置输入路径和输出路径
        ...
        System.out.println("输入路径:"+args[0]+" ,输出路径: "+args[1]);
//        7.提交Job
//        job.submit();
