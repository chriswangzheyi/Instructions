...
#### 查看UI界面
	...
	http://192.168.3.121:8088/cluster
...
插入：
	...
	export SCALA_HOME=/home/zheyi/scala
...
插入：
	...
	#指定master的IP
	export SPARK_MASTER_HOST=hudi3
	...
	export SPARK_DAEMON_JAVA_OPTS="-Dspark.deploy.recoveryMode=ZOOKEEPER -Dspark.deploy.zookeeper.url=hudi2:2181,hudi3:2181,hudi4:2181  -Dspark.deploy.zookeeper.dir=/spark/ha"
...
#### 新建文件夹
	...
	mkdir /home/zheyi/spark/pids	
	
	
#### 配置各节点

	#hudi2
	scp -r /home/zheyi/scala zheyi@hudi2:/home/zheyi/
	scp -r /home/zheyi/spark  zheyi@hudi2:/home/zheyi/

	#hudi4
	scp -r /home/zheyi/scala zheyi@hudi4:/home/zheyi/
	scp -r /home/zheyi/spark  zheyi@hudi4:/home/zheyi/
